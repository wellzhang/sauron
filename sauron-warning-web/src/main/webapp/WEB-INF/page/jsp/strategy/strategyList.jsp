...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> 报警策略</a></li>
        ...
        <section class="content">
            <div class="row">
                <form action="/strategy/query" method="POST" class="form-inline">
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="...">
                                        <button type="button" id="modifyBtn" class="btn btn-default" data-toggle="modal"
                                                ...
                                                onclick="modify(${row.id},this)" data-button="修改" data-type="mod">查看/修改
                                        </button>
