...
public final class ExecutorFactory {
    ...
    private static final ThreadFactory DEFAULT_THREAD_FACTORY = new SauronThreadFactory("Pinpoint-defaultThreadFactory", true);
    ...
    public static ThreadPoolExecutor newFixedThreadPool(int nThreads, int workQueueMaxSize, String threadFactoryName, boolean daemon) {
        ThreadFactory threadFactory = new SauronThreadFactory(threadFactoryName, daemon);
