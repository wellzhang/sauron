    ...
    <aside class="right-side">
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                <p>
                <form id="searchForm" action="/rule/list/1/10/2" method="POST" class="form-inline" style="margin-left: 15px;">

                    <label>应用名: <input value="${appName}" name="appName" type="text" aria-controls="example1"></label>
                    <label>监控KEY: <input value="${monitorKey}" name="monitorKey" type="text" aria-controls="example1"></label>
            ...
            <div class="table-responsive">
                <div class="box-header">
                    <p>
                    <div class="box-body">
                        <a class="btn btn-app" href="/rule/addCustom">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group" contenteditable="false">
                            <label for="rule-key" class="control-label">KEY</label>
                            <input type="text" class="form-control"
                                   id="rule-key" readOnly="true"/>
                        </div>
                        <div class="form-group" contenteditable="false">
