    ...
    <aside class="right-side">
        ...
        <section class="content">
            <div class="box box-primary">
                <p>
                <form action="/dubboRule/query" method="POST" class="form-inline" style="margin-left: 15px;">
            ...
            <div class="table-responsive">
                <div class="box-header">
                    <p>
                    <div class="box-body">
                    <a class="btn btn-app" href="/dubboRule/add">
                ...
                <div class="box-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-warning btn-flat btn-xs" href="/dubboRule/modify/${iterm.id}">编辑</a></td>
                        </tr>
                        </c:forEach>
                        </tbody></table>
                </div>
...
<script>
    ...
    $(function () {
        ...
        $(".enable-app").click(function () {
            ...
            if(undefined != status){
                $.post("/dubboRule/enableOrDisable",
