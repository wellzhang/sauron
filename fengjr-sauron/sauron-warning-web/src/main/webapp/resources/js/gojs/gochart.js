(function (window, go, $, _) {
    ...
    window.ServerMapIcons = {
        'MQ': 'ACTIVEMQ_CLIENT.png',
        'APACHE': 'APACHE.png',
    ...
    window.ServerMap = $.Class({
        $init: function (htOption, showOverView) {
            this._query = "";
            this._oldLinkColor = {};
            this.option({
                "sContainerId": '',
                ...
                "sImageDir": '/resources/js/gojs/images/icons/',
                "sBoldKey": null,
                "htIcons": window.ServerMapIcons,
                "htNodeTheme": {
                    "default": {
                ...
                "htLinkTheme": {
                    "default": {
                        "backgroundColor": "#ffffff",
                        "borderColor": "#c5c5c5",
                        "linkColors": ["#c5c5c5", "#c36911", "#c30014"],
                ...
                "fOnLinkMouseHover": function (eMouseEvent, htData) {
                },
                "fOnLinkMouseLeave": function (eMouseEvent, htData) {
                },
            });
            ...
            this._initOverview(showOverView);
        },
        ...
        _initNodeTemplates: function () {
            ...
            var getNodeTemplate = function (sImageName) {
                var _template = self.$(
                    ...
                    go.Panel.Auto,
                    {
                        ...
                        mouseHover: self._onNodeMouseHover.bind(self),
                        mouseLeave: self._onNodeMouseLeave.bind(self),
                    },
                    self.$(
                        go.Shape,
                        {
                    ...
                    self.$(
                        ...
                        //         },
                        //         new go.Binding("visible", "", function (data) {
                        //             return false; // data.isAuthorized && data.hasAlert;
                        //         })
                        //     ),
                        //     self.$(
                        //         go.Picture,
                        ...
                        // {
                        //     toolTip:
                        //         self.$(go.Adornment, 'Auto',
                        //             self.$(go.Shape, { fill: "#FFFFCC" }),
                        //             self.$( go.Panel,go.Panel.Table,
                        //                 {
                        //                     padding:2,
                        //                     minSize:new go.Size(100,20),
                        //                     defaultStretch: go.GraphObject.Horizontal,
                        //                     itemTemplate: self.$(go.Panel,
                        //                         go.Panel.TableRow,
                        //                         {},
                        //                         self.$(
                        //                             go.TextBlock,
                        ...
                        //                     )
                        //                 },
                        //                 new go.Binding("itemArray", "urlList")
                        //             )
                        //         )
                        // ,
                        // self.$(go.Shape, { fill: "#FFFFCC" }),
                        // self.$(go.TextBlock, { margin: 4 },
                        //     new go.Binding("text", "",function(data){
                        //         var _html = '';
                        //         _html += '<table>'
                        //         +'<tr><td>asdfasdfasdf</td><td>asdfasdfasdf</td><td>asdfasdfasdf</td></tr>';
                        //         return _html;
                        //     }))
                        // )
                        // }
                ...
                // _template.selectionAdornmentTemplate = self.$(go.Adornment, 'Auto',
                //     self.$(go.Shape, {fill: "#FFFFCC"}),
                //     self.$(go.Panel, go.Panel.Table,
                //         {
                //             padding: 2,
            ...
            var unknownTableTemplate = self.$(
                    ...
                    go.TextBlock, {
                        ...
                        click: function (e, obj) {
                            ...
                            if (obj.part.data.isCollapse) {
                                ...
                                self._onNodeSubGroupClicked(e, obj, groupData["groups"][e.targetObject.row].key, groupData.nodeName);
                            }
                            return false;
                        }
                ...
                self.$(
                    ...
                    // }),
                    new go.Binding('text', '', function (data) {
                        // "totalCount": 100,"failCount":20,"cost":100,"status":"ok"
                        return 'total:' + data.totalCount + ',fail:' + data.failCount + ',cost:' + data.cost + ',status:' + data.status;
                    })
                )
            );
        ...
        _initLinkTemplates: function () {
            var self = this,
                ...
                option = {
                    ...
                    mouseHover: this._onLinkMouseHover.bind(self),
                    mouseLeave: this._onLinkMouseLeave.bind(self),

                    layerName: "Foreground",
                    reshapable: true, // to disable reshape on links
                ...
                return self.$(
                    ...
                    self.$(
                        go.Shape,  // the link shape
                        {
                            name: "LINK",
                            isPanelMain: true,
                            stroke: "red",//htOption.borderColor,
                            strokeWidth: 2,
                        },
                        new go.Binding("stroke", "status", function (v) {
                            var index = v * 1;
                            return htOption.linkColors[index];
                        })
                    ),
                    self.$(
        ...
        _initDiagramEnvironment: function () {
            ...
            this._oDiagram.addDiagramListener("BackgroundSingleClicked", function (e) {
                ...
                if (jQuery.isFunction(fOnBackgroundClicked)) {
            ...
            this._oDiagram.addDiagramListener("BackgroundDoubleClicked", function (e) {
                ...
                if (jQuery.isFunction(fOnBackgroundDoubleClicked)) {
            ...
            this._oDiagram.addDiagramListener("BackgroundContextClicked", function (e) {
                ...
                if (jQuery.isFunction(fOnBackgroundContextClicked)) {
         ...
         */
        _initOverview: function (showOverView) {
            if (showOverView) {
        ...
        _highlightLink: function (shape, theme, toFill) {
            ...
            if (!this._oldLinkColor[shape.__gohashid]) {
                this._oldLinkColor[shape.__gohashid] = shape.stroke;
            }
            var color;
            if (theme) {
                ...
                color = this._oldLinkColor[shape.__gohashid];
                // if (!color) {
        ...
        _onNodeSubGroupClicked: function (e, obj, unknownKey, fromName) {
            ...
            console.info("_onNodeSubGroupClicked", e, node, unknownKey, fromName);

            if (jQuery.isFunction(fOnNodeSubGroupClicked)) {
        ...
        _onNodeClicked: function (e, obj, unknownKey, query) {
            ...
            if (jQuery.isFunction(fOnNodeClicked)) {
        ...
        _onNodeDoubleClicked: function (e, obj) {
            ...
            if (jQuery.isFunction(fOnNodeDoubleClicked)) {
        ...
        _onNodeContextClicked: function (e, obj) {
            ...
            if (jQuery.isFunction(fOnNodeContextClicked)) {
                fOnNodeContextClicked.call(this, e, htData);
            }
        },

        _onNodeMouseHover: function (e, obj) {
            var node = obj.part,
                htData = node.data,
                fOnNodeMouseHover = this.option('fOnNodeMouseHover');

            if (jQuery.isFunction(fOnNodeMouseHover)) {
                fOnNodeMouseHover.call(this, e, htData);
            }
        },

        _onNodeMouseLeave: function (e, obj) {
            var node = obj.part,
                htData = node.data,
                fOnNodeMouseLeave = this.option('fOnNodeMouseLeave');

            if (jQuery.isFunction(fOnNodeMouseLeave)) {
                fOnNodeMouseLeave.call(this, e, htData);
            }
        },

        _onLinkMouseHover: function (e, obj) {
            var node = obj.part,
                htData = node.data,
                fOnLinkMouseHover = this.option('fOnLinkMouseHover');

            if (jQuery.isFunction(fOnLinkMouseHover)) {
                fOnLinkMouseHover.call(this, e, htData);
            }
        },
        _onLinkMouseLeave: function (e, obj) {
            var node = obj.part,
                htData = node.data,
                fOnLinkMouseLeave = this.option('fOnLinkMouseLeave');

            if (jQuery.isFunction(fOnLinkMouseLeave)) {
                fOnLinkMouseLeave.call(this, e, htData);
            }
        },
        ...
        _onLinkClicked: function (e, obj) {
            ...
            if (jQuery.isFunction(fOnLinkClicked)) {
        ...
        _onLinkContextClicked: function (e, obj) {
            ...
            if (jQuery.isFunction(fOnLinkContextClicked)) {
                htData.fromNode = obj.fromNode.part.data;
                htData.toNode = obj.toNode.part.data;
            ...
            while (allNodes.next()) {
                ...
                if (node.data.unknownNodeGroup) {
                    ...
                    for (var i = 0; i < unknownNodeGroup.length; i++) {
                        if (reg.test(unknownNodeGroup[i].nodeName)) {
                    ...
                    if (node.data.nodeName) {
                        if (reg.test(node.data.nodeName)) {
