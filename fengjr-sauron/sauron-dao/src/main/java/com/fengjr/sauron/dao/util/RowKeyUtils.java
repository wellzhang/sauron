...
import com.fengjr.sauron.commons.utils.TimeUtils;
import com.fengjr.sauron.dao.hbase.buffer.BytesUtils;

import static com.fengjr.sauron.commons.utils.SauronConstants.AGENT_NAME_MAX_LEN;

import static com.fengjr.sauron.dao.hbase.buffer.BytesUtils.INT_BYTE_LENGTH;
import static com.fengjr.sauron.dao.hbase.buffer.BytesUtils.LONG_BYTE_LENGTH;
