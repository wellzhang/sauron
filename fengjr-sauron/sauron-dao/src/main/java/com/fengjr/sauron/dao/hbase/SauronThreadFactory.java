 ...
 */
public class SauronThreadFactory implements ThreadFactory {
    ...
    public SauronThreadFactory() {
        this("Pinpoint", false);
    }

    public SauronThreadFactory(String threadName) {
        this(threadName, false);
    }

    public SauronThreadFactory(String threadName, boolean daemon) {
        if (threadName == null) {
    ...
    public static ThreadFactory createThreadFactory(String threadName, boolean daemon) {
        return new SauronThreadFactory(threadName, daemon);
    }
}
