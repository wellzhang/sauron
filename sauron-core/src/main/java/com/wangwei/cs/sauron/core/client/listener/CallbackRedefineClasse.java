...
import com.wangwei.cs.sauron.core.client.plugin.TransformerFactory;
...
public class CallbackRedefineClasse {
    ...
    public void start() {
        ...
        InstrumentationInitializer javaAgentWeaver = null;

        try {
            javaAgentWeaver = InstrumentationInitializer.getInstance();
        } catch (Exception e1) {
            e1.printStackTrace();
        } catch (Throwable e1) {
            e1.printStackTrace();
